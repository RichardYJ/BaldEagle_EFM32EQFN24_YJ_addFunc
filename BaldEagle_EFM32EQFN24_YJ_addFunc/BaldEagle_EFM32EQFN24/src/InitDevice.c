...
extern void enter_DefaultMode_from_BusFreeMode(void) {
	...
	CLOCK_0_enter_DefaultMode_from_BusFreeMode();
...
extern void CLOCK_0_enter_DefaultMode_from_BusFreeMode(void) {
	// $[HFOSC1 Setup]
	// [HFOSC1 Setup]$
...
extern void PORTS_2_enter_DefaultMode_from_BusFreeMode(void) {
